...
INSERT INTO tb_user (name, email, password) VALUES ('Bob Allen', 'bob@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
...
INSERT INTO tb_resource (title, description, position, img_uri, type, offer_id) VALUES ('Fórum', 'Tire suas dúvidas', 2, 'https://cdn.pixabay.com/photo/2020/05/31/09/40/online-course-5242018_1280.jpg', 2, 1);
...
INSERT INTO tb_content (id, text_content, video_uri) VALUES (1, 'Material de apoio: Abc', 'https://www.youtube.com/watch?v=cSFskNH1E5k');

INSERT INTO tb_lesson (title, position, section_id) VALUES('Aula 2 do Cap. 1', 2, 1);
INSERT INTO tb_content (id, text_content, video_uri) VALUES (2, '', 'https://www.youtube.com/watch?v=cSFskNH1E5k');

INSERT INTO tb_lesson (title, position, section_id) VALUES('Aula 3 do Cap. 1', 3, 1);
INSERT INTO tb_content (id, text_content, video_uri) VALUES (3, '', 'https://www.youtube.com/watch?v=cSFskNH1E5k');

INSERT INTO tb_lesson (title, position, section_id) VALUES('Tarefa do Cap. 1', 4, 1);
INSERT INTO tb_task (id, description, question_count, approval_count, weight, due_date) VALUES(4,'Tarefa de conclusão', 5, 4, 1.0, TIMESTAMP WITH TIME ZONE '2020-11-25T13:00:00Z');
